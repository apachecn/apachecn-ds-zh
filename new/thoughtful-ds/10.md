...
再次感谢读者，祝贺您阅读这些长章节并尝试了部分或全部示例代码的漫长旅程。 我试图在深入研究特定主题的基础知识（例如深度学习或时间序列分析）与为从业者提供全面的示例代码之间提供良好的组合。 我特别希望您发现在单个 Jupyter笔记本中将数据科学分析与 PixieApp 应用编程模型紧密集成的想法有趣且新颖。 但是，最重要的是，我希望您发现它有用，并且可以在您自己的项目中以及与您自己的团队一起重用。
