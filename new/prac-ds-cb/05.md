...
1.  从 [http://www.bls.gov/cew/data/files/2012/csv/2012_annual_singlefile.zip](http://www.bls.gov/cew/data/files/2012/csv/2012_annual_singlefile.zip) 下载 76.8 MB 压缩数据，并将其保存到您会记得的位置。
...
*   请参阅 [https://github.com/hadley/dplyr/blob/master/README.md](https://github.com/hadley/dplyr/blob/master/README.md) 上提供的`dplyr`参考资料，其中包含指向小插图和其他参考资料的链接。
*   请参阅 [http://cran.r-project.org/web/packages/ggplot2/ggplot2.pdf 上的`ggplot2`参考手册。](http://cran.r-project.org/web/packages/ggplot2/ggplot2.pdf)
*   请参阅 [https://code.google.com/p/sqldf/](https://code.google.com/p/sqldf/) 上提供的`sqldf`参考资料。
...
*   请参阅 [http://www.sqlite.org](http://www.sqlite.org) 上提供的 SQLite 文档。
*   请参阅 [http://datatable.r-forge.r-project.org/](http://datatable.r-forge.r-project.org/) 上提供的`data.table`文档。
...
*   请参阅 [http://www.bls.gov/cew/doc/layouts/csv_annual_layout.htm](http://www.bls.gov/cew/doc/layouts/csv_annual_layout.htm) 上可用数据集的文档。
...
*   在[中了解有关 R 中的正则表达式的信息，网址为 http://stat.ethz.ch/R-manual/R-patched/library/base/html/regex.html](http://stat.ethz.ch/R-manual/R-patched/library/base/html/regex.html)
*   请参阅[上有关 **`stringr`** 库的信息，网址为 http://journal.r-project.org/archive/2010-2/RJournal_2010-2_Wickham.pdf](http://journal.r-project.org/archive/2010-2/RJournal_2010-2_Wickham.pdf)
...
*   在[上获取有关`dplyr`的更多详细信息，网址为 http://blog.rstudio.org/2014/01/17/introducing-dplyr/](http://blog.rstudio.org/2014/01/17/introducing-dplyr/)
...
*   请参阅 [http://www.ggplot2.org 上的`ggplot2`文档。](http://www.ggplot2.org)
...
*   在 [http://rmaps.github.io](http://rmaps.github.io) 和 [http://rmaps.github.io/blog/posts/animated-choropleths/](http://rmaps.github.io/blog/posts/animated-choropleths/) 中了解有关`rMaps`程序包的信息。
*   在 [https://github.com/trulia/choroplethr](https://github.com/trulia/choroplethr) 上了解有关`choroplethr`软件包的信息。
*   在[上查看`choropleth`挑战结果，网址为 http://blog.revolutionanalytics.com/2009/11/choropleth-challenge-result.html](http://blog.revolutionanalytics.com/2009/11/choropleth-challenge-result.html)
*   在[上查看动画地图的示例，网址为 http://www.r-bloggers.com/animated-choropleths-using-animation-ggplot2-rcharts-googlevis-and-shiny-to-visualize-violent-crime-rates- 跨 5 个州/州的不同状态/](http://www.r-bloggers.com/animated-choropleths-using-animation-ggplot2-rcharts-googlevis-and-shiny-to-visualize-violent-crime-rates-in-different-us-states-across-5-decades/)
...
流行的 **`rCharts`** 程序包的创建者 Vaidyanathan 博士也创建了`rMaps`程序包。 它使用 JavaScript 可视化库从 R 中创建了鹅卵石，以便在 Web 上进行演示，还可以使用`ichoropleth.`函数创建动画的鹅卵石。但是，在编写本文时，该包仍在开发中，因此我们没有该功能 创建县级地图。 在 [http://rmaps.github.io/blog/posts/animated-choropleths/](http://rmaps.github.io/blog/posts/animated-choropleths/) 的`rMaps`博客中显示了具有状态级别映射的示例。
...
*   Hadley Wickham 在他的在线书籍中有一个关于基准测试的很好的阐述，可以在 [http://adv-r.had.co.nz/Performance.html](http://adv-r.had.co.nz/Performance.html) 上找到。 他推广`microbenchmark`软件包以进行基准测试。