...
*   请参阅[这个页面](https://github.com/hadley/dplyr/blob/master/README.md)上提供的`dplyr`参考资料，其中包含指向小插图和其他参考资料的链接。
*   请参阅[这个页面](http://cran.r-project.org/web/packages/ggplot2/ggplot2.pdf)
*   请参阅[这个页面](https://code.google.com/p/sqldf/)上提供的`sqldf`参考资料。
...
*   在[这个页面](http://rmaps.github.io)和 [http://rmaps.github.io/blog/posts/animated-choropleths/](http://rmaps.github.io/blog/posts/animated-choropleths/) 中了解有关`rMaps`程序包的信息。
*   在[这个页面](https://github.com/trulia/choroplethr)上了解有关`choroplethr`软件包的信息。
