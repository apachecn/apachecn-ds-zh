...
可以从 [http://topincomes.g-mond.parisschoolofeconomics.eu/](http://topincomes.g-mond.parisschoolofeconomics.eu/) 下载世界最高收入的原始数据集。 但是，该站点已进行了多次更新，从而更改了数据的输出格式（从`.csv`更改为`.xlsx`）。 该配方采用`.csv`文件格式。 本章的存储库包含输入数据文件的正确格式版本。
...
*   位于[的 NumPy 文档 http://docs.scipy.org/doc/numpy/reference/](http://docs.scipy.org/doc/numpy/reference/)
*   关于 NumPy 和 SciPy 的强大教程，网址为[，网址为 http://www.engr.ucsb.edu/~shell/che210d/numpy.pdf](http://www.engr.ucsb.edu/~shell/che210d/numpy.pdf)
...
*   对于数据源，请访问 [http://topincomes.g-mond.parisschoolofeconomics.eu/](http://topincomes.g-mond.parisschoolofeconomics.eu/)
*   Python 上的*模板[中的](https://wiki.python.org/moin/Templating)*文章 https://wiki.python.org/moin/Templating
*   *什么是数据科学？ [上的](http://radar.oreilly.com/2010/06/what-is-data-science.html)*文章 http://radar.oreilly.com/2010/06/what-is-data-science.html
*   在[中的在 OSX Mountain Lion 中设置 Python 和 Matplotlib 的文章 http://www.tapir.caltech.edu/~dtsang/python.html](http://www.tapir.caltech.edu/~dtsang/python.html)
