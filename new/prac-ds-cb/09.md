...
*   Twitter 的 OAuth 实施位于[这个页面](https://dev.twitter.com/docs/auth/oauth)
*   Twitter 的 *OAuth 常见问题解答*网页 [https://dev.twitter.com/docs/auth/oauth/faq](https://dev.twitter.com/docs/auth/oauth/faq)
*   OAuth 主页位于[这个页面](http://oauth.net/)
*   *其他* *Twitter 库*，位于[这个页面](https://dev.twitter.com/docs/twitter-libraries)
...
*   Twitter 用户配置文件 JSON 的描述位于[这个页面](https://dev.twitter.com/docs/platform-objects/users)
...
*   **CouchDB** 主页位于[这个页面](http://couchdb.apache.org/)
*   **MongoLab** 主页 [https://mongolab.com/welcome/](https://mongolab.com/welcome/)
*   **MongoHQ** 主页位于[这个页面](http://www.mongohq.com/)[-](http://www.mongohq.com/)
