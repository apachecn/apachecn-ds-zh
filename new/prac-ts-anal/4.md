...
从前面的行可以看出，第二个差异不是两个周期之前，而是第一个差异的差异，即 *d* = 1。 假设![](img/4d4dbf36-d8e6-4297-b24f-2f9593d64d47.png)代表不同的响应，因此 ARIMA 预测可以写成以下形式：
