...
首先，我们设置参数以连接到服务。 为此，您需要使用开发人员密钥进行 Reddit。 为了获得此密钥，请登录 [https://www.reddit.com/login](https://www.reddit.com/login) 网站并转到[这个页面](https://www.reddit.com/prefs/apps)。 从此处单击**，您是开发人员吗？ 创建一个应用程序…**并填写表格，将类型设置为*脚本*。 您将获得客户端 ID 和一个秘密，可以将其添加到新的 IPython Notebook 中：
