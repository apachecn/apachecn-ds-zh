...
这些方程式的推导超出了本模块的范围，但我建议感兴趣的读者详细阅读 [http://en.wikibooks.org/wiki/Support_Vector_Machines](http://en.wikibooks.org/wiki/Support_Vector_Mach) 的推导。 另外，您可以访问[这个页面](http://docs.opencv.org/doc/tutorials/ml/introduction_to_svm/introduction_to_svm.html)。
