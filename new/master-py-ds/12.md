...
可以从 [https://hadoop.apache.org/](https://hadoop.apache.org/) 下载并安装 Hadoop。 我们将使用 Hadoop 流 API 来在 Hadoop 中执行 Python MapReduce 程序。 Hadoop Streaming API 可帮助使用具有标准输入和输出的任何程序作为 MapReduce 程序。
...
**Hadoopy** 是 Python 中的一个库，它提供了一个与 Hadoop 交互以管理文件并对其执行 MapReduce 的 API。 可以从 [http://www.Hadoopy.com/en/latest/tutorial.html#installing-Hadoopy](http://www.Hadoopy.com/en/latest/tutorial.html#installing-Hadoopy) 下载 Hadoopy。
...
Pig Latin 是的文字语言，可以从 [http://pig.apache.org/docs/r0.7.0/piglatin_ref2.html](http://pig.apache.org/docs/r0.7.0/piglatin_ref2.html) 学习。
...
另外，您可以在 [https://www.coursera.org/learn/machine-learning](https://www.coursera.org/learn/machine-learning) 上注册来学习机器学习的 Andrew NG 课程，以了解机器学习算法背后的细微差别。