...
数据集可从 [http://grouplens.org/datasets/movielens/](http://grouplens.org/datasets/movielens/) 获得，我们将在本章中使用的数据集是 MovieLens 100 万数据集。 下载此数据集并将其解压缩到您的数据文件夹中。 启动一个新的 IPython Notebook 并输入以下代码：
