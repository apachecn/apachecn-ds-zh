...
让我们从[第 2 章](../Text/2.xhtml#aid-K0RQ2 "Chapter 2\. Interpolation and Approximation")，*插值和近似*中重新审视 Runge 的示例，在该示例中，我们使用了从`-5`到`5`的间隔中的 11 个等距节点计算了 Runge 函数的 Lagrange 插值：
