...
如果尚未安装  ，请安装`statsmodels`以进行正常性测试（请参阅第 10 章，“Scikits 的乐趣”的“安装 scikits-statsmodels”秘籍）。
...
*   “使用 Statsmodels”秘籍执行正常性测试，该秘籍来自第 10 章，“Scikits 的乐趣”
...
*   “探索大气压”秘籍
*   `percentile()`函数的  文档位于[，网址为 http://docs.scipy.org/doc/numpy-dev/reference/produced/numpy.percentile.html](http://docs.scipy.org/doc/numpy-dev/reference/generated/numpy.percentile.html)