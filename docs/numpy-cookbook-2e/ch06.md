...
对于本教程，您可能需要阅读[有关**勾股三角**的维基百科页面](http://en.wikipedia.org/wiki/Pythagorean_triple)。 毕达哥拉斯三元组是一组三个自然数，即< b < c，为此， ![Finding Pythagorean triples](img/0945OS_06_04.jpg)。
