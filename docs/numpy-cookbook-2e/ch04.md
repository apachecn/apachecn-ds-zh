...
*   *在第 2 章，*高级索引和数组概念*中安装 PIL*
*   *在第 2 章，*高级索引和数组概念*中安装 SciPy*
...
安装  MATLAB 或 Octave 超出了本书的范围。 [Octave 网站](http://www.gnu.org/software/octave/download.html)上有一些安装的指南。 检查 *ShtPy* SciPy 的说明，另请参阅  本秘籍的 部分。
...
在第 1 章，*和 IPython* 一起缠绕中，我们已经看到了运行 PythonAnywhere 控制台的过程，而没有任何权限。 此秘籍将需要您有一个帐户，但不要  担心-它是免费的，如果您不需要太多资源，至少  是免费的。
