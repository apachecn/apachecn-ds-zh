...
现成的包装有个选择：Anaconda，有思想的顶篷，Algorete Loopy 等！ 所有这些软件包都一次性提供了 Python，SciPy，NumPy，matplotlib 等（文本编辑器和精美的交互式 shell）。 实际上，所有这些系统都安装了自己的软件包管理器，从那里可以像在典型的 Linux 发行版上那样安装/卸载其他软件包。 为了简洁起见，我们将仅提供“思想层面”的说明。 所有其他系统都在线提供大量文档，因此安装它们应该不会有太大问题。
