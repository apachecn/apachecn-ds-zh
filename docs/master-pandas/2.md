...
先前 **PYMC 熊猫** **示例**的图片来自 [http://healthyalgorithms.files.wordpress.com/2012/01/pymc-pandas-example.png](http://healthyalgorithms.files.wordpress.com/2012/01/pymc-pandas-example.png) 。
